            ...
            if type(value) is not dict:
                ...
                if "event_type" in value:
                    ...
                    if type(eventType) is not str:
                        print("Warning : event_type in event %s should be a string, %s given." % (eventName, type(event_type).__name__))
                        fatalError = True
                    else:
                ...
                if "is_triggered_only" in value:
                    ...
                    print("Warning : event %s is missing a is_triggered_only!" % focusName)
                    fatalError = True
